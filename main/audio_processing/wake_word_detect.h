...
private:
    ...
    // 添加缓冲区大小限制
    static constexpr size_t MAX_PCM_BUFFER_SIZE = 10;  // 最多保存10个PCM缓冲区
    static constexpr size_t MAX_OPUS_BUFFER_SIZE = 20; // 最多保存20个Opus缓冲区
    size_t total_pcm_size_ = 0;  // 当前PCM数据总大小
    size_t total_opus_size_ = 0; // 当前Opus数据总大小
